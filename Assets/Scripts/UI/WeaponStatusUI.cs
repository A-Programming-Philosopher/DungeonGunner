...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #endregion Tooltip
    [SerializeField] private TextMeshProUGUI reloadText;//text de hien thi dan
    #region Tooltip
    [Tooltip("Populate with the TextMeshPro-Text component on the child AmmoRemainingText gameobject")]
    #endregion Tooltip
    [SerializeField] private TextMeshProUGUI ammoRemainingText;//text de hien thi dan con lai
    #region Tooltip
    ...
    /// <summary>
    /// Update the ammo remaining text on the UI Update text thong bao so luong dan con lai
    /// </summary>
    ...
    /// <summary>
    /// Update ammo clip icons on the UI Update bang dan tren UI
    /// </summary>
    ...
    /// <summary>
    /// Update the blinking weapon reload text//Update weapon reload text nhap nhay
    /// </summary>
    ...
    /// <summary>
    /// Start Coroutine nhap nhay chu trong 0.3s
    /// </summary>
