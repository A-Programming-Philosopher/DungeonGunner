...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        playerNameInput.text = currentPlayer.playerName;// lay ten trong playerSO de dien vao o trong main menu UI
    ...
    /// <summary>
    /// Hien thi nhan vat len bang lua chon
    /// </summary>
    ...
    /// <summary>
    /// Chon nhan vat ke tiep, goi su kien OnClick() trong inspector
    /// </summary>
    ...
    /// <summary>
    /// Chon nhan vat truoc do, goi su kien OnClick() trong inspector
    /// </summary>
