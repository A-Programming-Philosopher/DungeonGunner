...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    [HideInInspector] public int[,] aStarMovementPenalty;  // luu giu movement penalty cho thuat toan tim kiem duong di A*
    ...
    private void AddObstaclesAndPreferredPaths()
    {
        ...
        for (int x = 0; x < (room.templateUpperBounds.x - room.templateLowerBounds.x + 1); x++)
        {
            ...
            {
                // Set gia tri movement penalty mac dinh
    ...
    /// <summary>
    /// Them cua neu room khong phai la dang corridor
    /// </summary>
    private void AddDoorsToRooms()
    {
        ...
        // Khoi tao door prefabs tai vi tri cua
        foreach (Doorway doorway in room.doorWayList)
        {
    ...
    /// <summary>
    /// Cap nhat mang cua movable object
    /// </summary>
    public void UpdateMoveableObstacles()
    {
        ...
        foreach (MoveItem moveItem in moveableItemsList)
        {
            ...
            for (int i = colliderBoundsMin.x; i <= colliderBoundsMax.x; i++)
            {
                ...
                {
                    aStarItemObstacles[i - room.templateLowerBounds.x, j - room.templateLowerBounds.y] = 0;//mang chua toa do cua toan bo cell cua movable object
                }
            }
        }
    }
