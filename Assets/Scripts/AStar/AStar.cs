...
public static class AStar
{
    ...
    public static Stack<Vector3> BuildPath(Room room, Vector3Int startGridPosition, Vector3Int endGridPosition)
    {
        ...
        // Tao GridNodes de tim kiem duong di
        GridNodes gridNodes = new GridNodes(room.templateUpperBounds.x - room.templateLowerBounds.x + 1, room.templateUpperBounds.y - room.templateLowerBounds.y + 1);//width & height
    ...
    private static Stack<Vector3> CreatePathStack(Node targetNode, Room room)
    {
        ...
        // Lay toa do diem giua cua o vuong
    ...
    {
        // Neu node ke can vuot qua pham vi thi tra ve null
