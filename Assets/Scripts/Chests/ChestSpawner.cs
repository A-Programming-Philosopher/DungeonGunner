...
public class ChestSpawner : MonoBehaviour
{
    ...
    {
        public DungeonLevelSO dungeonLevel; //ti le spawn phu thuoc vao level
    ...
    #endregion Tooltip
    [SerializeField] private GameObject chestPrefab;// da duoc gan prefab Chest trong ChestSpawner prefab
    ...
    {
        // Subscribe su kien room changed event
    ...
    {
        // Unsubscribe su kien room changed event
        StaticEventHandler.OnRoomChanged -= StaticEventHandler_OnRoomChanged;
    ...
    private void StaticEventHandler_OnRoomEnemiesDefeated(RoomEnemiesDefeatedArgs roomEnemiesDefeatedArgs)
    {
        ...
        {
            SpawnChest();// neu enemy chet thi sinh ra phong moi
        }
    }
    ...
    private void SpawnChest()
    {
        ...
        GetItemsToSpawn(out int ammoNum, out int healthNum, out int weaponNum);//lay so luong moi item can spawn

        // Instantiate chest
        GameObject chestGameObject = Instantiate(chestPrefab, this.transform);//khoi tao chest
        ...
        //Chest o dau nay la chest class 
        Chest chest = chestGameObject.GetComponent<Chest>();//Get cai component Chest nam trong chest prefabs
    ...
    /// <summary>
    /// Kiem tra dam bao random nho hon chance percent
    /// </summary>
