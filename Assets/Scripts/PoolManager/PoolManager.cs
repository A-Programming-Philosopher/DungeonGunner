...
public class PoolManager : SingletonMonobehaviour<PoolManager>
{
    ...
    /// <summary>
    /// Tao object pool voi prefab va kich co duoc chi dinh truoc
    /// </summary>
    private void CreatePool(GameObject prefab, int poolSize, string componentType)
    {
        ...
        GameObject parentGameObject = new GameObject(prefabName + "Anchor"); // tao game object cha cho game object gan vao
    ...
    /// <summary>
    /// Lay game object tu object pool
    /// </summary>
